...
<div class="profilecard">
    ...
    <div class="profilecard__avatar">
      <img src="/images/default.jpg" alt="" height={'100%'} width={'100%'} style={{borderRadius:'100px'}} className='pic'/>
    </div>

    <div class="profilecard__title">{data.name}</div>
    <div class="profilecard__subtitle">{data.email}</div>
    <div class="profilecard__subtitle">{data.phone}</div>

    <div class="profilecard__wrapper">
        <button class="profilecard__btn"><Link to={`/editprofile/${id}`} className='pathprofile'>Edit</Link></button>
        <button class="profilecard__btn card__btn-solid">Add photo</button>
    </div>
</div>
